...
void showImage(cv::Mat &image, cv::Mat &_DistributedImage)
{
...
void drawChessBoard(cv::Mat &image_input, cv::Mat &_DistributedImage, const std::vector<cv::Point2f> &imagePoints)
{
    int drawShiftBits = 4;
...
void callback_0(const sensor_msgs::Image::ConstPtr &img)
{
